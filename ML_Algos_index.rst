.. Stock Prediction Machine Learning Algorithms Software Manual documentation master file, created by
   sphinx-quickstart on Sat May 14 16:25:10 2023.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to Stock Prediction Machine Learning Algorithms Software Manual's documentation!
===================================================
...
Import libraries, SetUp PySpark, Read the Data
----------------------------

The first step is to import required libraries, set up PySpark and read the data. This is done with the following code:
...
For the data file, I am using the StockPredict_Data.csv file which is included in the repository
-------------------------------------------------------------
...
Preprocessing, Bloomfilter, Spark ML Pipeline Setup
-------------------------------------------------------------

The next step is to preprocess the data, apply bloomfilter and setup spark ml pipeline. This is done with the following code:
...
Machine Learning Algorithms implementation and Crossvalidation Evaluation
------------------------------------------------------------------------------------------

The final step is to implement machine learning algorithms and do cross validation evaluation. This is done with the following code:
